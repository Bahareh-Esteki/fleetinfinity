...
const PartnerProgram = () => {
  const partnerFeatures = [
    {
      icon: <Palette className="w-6 h-6 text-brand-dark-blue" />,
      ...
      bg: "bg-brand-light-blue/10",
    },
    {
      icon: <TerminalSquare className="w-6 h-6 text-brand-green" />,
    ...
    {
      icon: <Rocket className="w-6 h-6 text-brand-dark-blue" />,
    ...
    {
      icon: <Building2 className="w-6 h-6 text-brand-green" />,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-10">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-brand-green border border-transparent rounded-lg hover:bg-brand-green-dark hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-green"
              >
                Discuss Partnership
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {partnerFeatures.map((feature, index) => (
              <div
                key={index}
                className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:border-brand-green/30 hover:bg-white hover:shadow-xl transition-all duration-300 group"
              >
                <div
